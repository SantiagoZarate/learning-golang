...
export function LandingPage() {
  return (
    <section className="w-full">
      <div className="absolute h-[65%] w-3/4 my-44 bg-stone-800 left-0 rounded-tr-full rounded-br-full" />
      <div className="min-h-screen max-w-screen-lg mx-auto h-full grid grid-cols-2">
        <article className="z-10 flex flex-col justify-center gap-2">
          <h1 className="text-[72px] font-bold text-yellow-400">Snippetbox</h1>
          <p>its like twitter but simpler</p>
          <p>Share what are you thinking at any time!</p>
          <Button className="uppercase w-fit rounded-full font-bold bg-yellow-700 text-yellow-300">
            Try it now!
          </Button>
        </article>
